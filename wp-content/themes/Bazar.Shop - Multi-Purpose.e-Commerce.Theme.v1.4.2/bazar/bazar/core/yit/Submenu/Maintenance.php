...
class YIT_Submenu_Maintenance extends YIT_Submenu_Abstract {
	...
	public function init() {
	    $this->_menu = apply_filters( 'yit_admin_menu_maintenance', array(
            'maintenance' => __( 'Customize Login Screen', 'yit' )
        ) );
        
        $this->_submenu = apply_filters( 'yit_admin_submenu_maintenance', array(
            'maintenance' => array(
