...
<div class="<?php if ( ! $has_thumbnail ) echo 'without ' ?>thumbnail">
        <div class="row">                
            ...
            <div class="meta group span3">              
                ...
                <div>
                    <?php echo do_shortcode( '[share icon_type="square" title="' . __( 'Share on', 'yit' ) . '" socials="facebook, twitter, google, pinterest"]' ); ?>
                </div>
            </div>
                ...
                <div>
                    ...
                    if( $attachments ) {
                        ...
                        foreach ( $attachments as $key => $attachment ) { 
                            $image = yit_image( "id=$attachment->ID&size=blog_elegant&output=array" );//wp_get_attachment_image_src( $attachment->ID, 'blog_elegant' );
