    ...
    public function init() {  
        return array(
            ...
            35 => array(
                ...
                'std' => '#333333',
                'style' => array(
                	'selectors' => '#header-cart-search .widget_shopping_cart .cart_wrapper .buttons .button.checkout',
                	'properties' => 'background-color'
				)
            ),
            36 => array(
                ...
                'std' => '#828282',
                'style' => array(
                	'selectors' => '#header-cart-search .widget_shopping_cart .cart_wrapper .buttons .button.checkout:hover',
                	'properties' => 'background-color'
				)
            ),
            37 => array(
                ...
                'std' => '#c58408',
                'style' => array(
                	'selectors' => '#header-cart-search .widget_shopping_cart .cart_wrapper .buttons .button',
                	'properties' => 'background-color'
				)
            ),
            38 => array(
                ...
                'std' => '#e79c0c',
                'style' => array(
                	'selectors' => '#header-cart-search .widget_shopping_cart .cart_wrapper .buttons .button:hover',
                	'properties' => 'background-color'
				)
            ),
            70 => array(
            ...
            290 => array(
                ...
                'std' => '#555555',
                'style' => array(
                	'selectors' => 'div.product form.cart .button:hover, #content div.product form.cart .button:hover, .cart .button:hover, input.checkout-button.alt.button:hover, .shipping-calculator-form .button:hover, .multistep_step .button:hover, #place_order.button:hover, .single-product .single_add_to_cart_button.button.alt:hover',
                	'properties' => 'background-color'
				)
            ),
            300 => array(
                ...
                'std' => '#FFFFFF',
                'style' => array(
                	'selectors' => '.product .summary .single_add_to_cart_button, .cart .button, input.checkout-button.alt.button, .shipping-calculator-form .button, .multistep_step .button, #place_order.button',
                	'properties' => 'color'
				)
            ),
            310 => array(
                ...
                'std' => '#FFFFFF',
                'style' => array(
                	'selectors' => 'div.product form.cart .button:hover, #content div.product form.cart .button:hover, .cart .button:hover, input.checkout-button.alt.button:hover, .shipping-calculator-form .button:hover, .multistep_step .button:hover, #place_order.button:hover',
                	'properties' => 'color'
				)
            ),   
            320 => array(
