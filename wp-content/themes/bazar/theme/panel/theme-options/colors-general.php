...
function yit_tab_colors_general( $fields ) {
    ...
    return array_merge( $fields, array(
        ...
        90 => array(
            ...
            'style' => array(
            	'selectors' => '.sidebar .cta .border-1, #footer .cta .border-1, div.yit_quick_contact > div',
            	'properties' => 'border-color'
			)
        ),
        100 => array(
            ...
            'style' => array(
            	'selectors' => '.sidebar .cta .border-2, #footer .cta .border-2, .yit_quick_contact > div:before',
            	'properties' => 'border-color'
			)
		),
        110 => array(
