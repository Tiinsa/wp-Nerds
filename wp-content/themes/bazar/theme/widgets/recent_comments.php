            ...
            <div class="the-post group">
                ...
                <div class="border">
	                ...
	                <span class="author">
		                ...
		                <?php endif ?><a class="title" href="<?php echo get_permalink( $comment->comment_post_ID ) . '#comment-' . $comment->comment_ID ?>"><?php echo get_the_title( $comment->comment_post_ID ) ?></a>
		                <br />
	                	<?php _e( 'from', 'yit' ) ?>
