...
<li class="<?php czr_fn_echo( 'element_class' ) ?>" <?php czr_fn_echo('element_attributes') ?>>
  <a href="<?php czr_fn_echo( 'wc_cart_url' ) ?>" title="<?php _e( 'View your shopping cart', 'customizr-pro' ); ?>" class="woocart cart-contents" <?php czr_fn_echo( 'wc_cart_link_attributes' ) ?>>
