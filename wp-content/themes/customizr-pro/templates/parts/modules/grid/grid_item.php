      ...
      <div class="tc-grid-caption">
          <div class="entry-summary <?php czr_fn_echo('entry_summary_class') ?>">
            ...
            <h2 class="entry-title over-thumb">
              <a class="czr-title" href="<?php the_permalink() ?>" title="<?php _e( 'Permalink to' , 'customizr-pro' ) ?> <?php echo esc_attr( strip_tags( get_the_title() ) ) ?>" rel="bookmark"><?php czr_fn_echo( 'title' ) ?></a>
            </h2>
            <?php
