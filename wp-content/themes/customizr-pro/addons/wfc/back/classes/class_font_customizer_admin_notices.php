    ...
    function tc_plugin_notice(){
        ...
        if ( ! get_user_meta( $user_id, 'tc_' . $this -> plug_prefix . '_notice' ) ) {
            printf( '<div class="updated"><p>%1$s</p><a href="%2$s">Dismiss</a></div>',
              sprintf( __('The <strong>%1$s</strong> plugin can not be used with a theme (or a parent theme) different than Customizr with a version less than v3.1.0.' , 'customizr-pro'),
                $this -> plug_name
                ),
