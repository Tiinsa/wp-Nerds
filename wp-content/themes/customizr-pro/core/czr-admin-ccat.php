        ...
        <div class="updated czr-update-notice" style="position:relative">
          <?php
            echo apply_filters(
              ...
              sprintf('<h3>%1$s %2$s %3$s %4$s :D</h3>',
                __( "Good, you've just upgraded to", "customizr-pro"),
          ...
          <?php if ( czr_fn_is_ms() ) : ?>
            <p>
              <?php
              printf(
                __( 'If you like %1$s please leave us a %2$s rating. A huge thanks in advance!', 'customizr-pro' ),
                sprintf( '<strong>%s</strong>', esc_html__( 'the Customizr theme', 'customizr-pro' ) ),
          ...
          <?php if ( ! CZR_IS_PRO ) : ?>
            ...
            <div id="extend" class="changelog">
              ...
              <div class="feature-section images-stagger-right">
                ...
                <h4 style="text-align: left;max-width:inherit"><?php _e('Easily take your web design one step further' ,'customizr-pro') ?></h4></br>
                ...
                <p style="text-align:left;max-width:inherit">
                    <a class="button-primary review-customizr hu-go-pro-btn" title="<?php _e("Discover Customizr Pro",'customizr-pro') ?>" href="<?php echo esc_url( CZR_WEBSITE . 'customizr-pro?ref=a' ); ?>" target="_blank"><?php _e("Discover Customizr Pro",'customizr-pro') ?> &raquo;</a>
                </p>
              </div>
            </div>
       ...
       */
        function czr_fn_post_slider_box( $post ) {
          ...
          <div class="meta-box-item-title">
               <h4><?php _e( 'Add a slider to this post/page' , 'customizr-pro' ); ?></h4>
      ...
      */
       ...
       */
        function czr_fn_attachment_slider_box( $post ) {
           ...
           ?>
          <div class="meta-box-item-title">
               <h4><?php _e( 'Add to a slider' , 'customizr-pro' ); ?></h4>
                 <label for="<?php echo $slider_check_id; ?>">
               </i><?php _e( 'Add to a slider (create one if needed)' , 'customizr-pro' ) ?></i>
             </label>
           </div>
           <div class="meta-box-item-content">
             <input name="tc_post_id" id="tc_post_id" type="hidden" value="<?php echo $post-> ID ?>"/>
